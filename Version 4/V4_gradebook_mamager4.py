...
def load_gradebook():
    try:
        with open("Version 4/gradebook_logs.json", "r") as f:
            return json.load(f)
...
def save_gradebook(gradebook):
    with open("Version 4/gradebook_logs.json", "w") as f:
...
def add_student(gradebook):
    ...
    while True:
        ...
        score_input = eg.enterbox(f"Enter score for {subject.title()} (0 to 100):")
